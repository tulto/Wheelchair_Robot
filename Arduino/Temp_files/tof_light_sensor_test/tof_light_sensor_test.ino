...
// defining the xshut pins for the different sensors
#define XSHT_SENSOR_1 5
#define XSHT_SENSOR_2 6
#define XSHT_SENSOR_3 7
...
std::vector<TOFLaserDistanzSensor*> sensors_all = {&sensor3, &sensor2, &sensor1};
...
void loop() {
  ...
  if(all_tof_sensors_data_ready){
    ...
    send_stair_warning(sensor1, sensor2, sensor3);
