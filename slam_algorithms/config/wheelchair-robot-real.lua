...
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.rotation_weight = 11

POSE_GRAPH.constraint_builder.fast_correlative_scan_matcher.angular_search_window = math.rad(12.0)
