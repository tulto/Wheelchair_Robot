...
hec_pose = PoseWithCovarianceStamped()

#___________________________________________________________________________________________________

#### CALLBACK-FUNCTION ####

def callback_hector_pose(pose_with_covariance):
        
        #give PoseWithCovarianceStamped values from subscribed topic to global variable hec_pose
        hec_pose.header = pose_with_covariance.header
        hec_pose.pose = pose_with_covariance.pose
...
if __name__ == '__main__':
        ...
        lookup_rate = rospy.get_param(node_name + "/lookup_rate", 30)
        ...
        #rate to search for and publish data
        ...
        #repeat code until node is shut down
